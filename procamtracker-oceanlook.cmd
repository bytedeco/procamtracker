...
:SERVER
start %JAVA%w -server %OPTIONS% -jar "%~dp0\procamtracker.jar" --laf javax.swing.plaf.metal.MetalLookAndFeel %*
if errorlevel 1 goto PAUSE
goto END

:DEFAULT
echo WARNING: Server JVM not available. Executing with default JVM...
%JAVA%w %OPTIONS% -jar "%~dp0\procamtracker.jar" --laf javax.swing.plaf.metal.MetalLookAndFeel %*
if errorlevel 1 goto PAUSE
goto END
